...
import cn.com.guangduo.common.util.StringTool;
import cn.com.guangduo.common.util.validate.ValidateUtil;
import cn.com.guangduo.iface.common.enums.MethodType;
...
public abstract class BaseController<MODEL extends BaseModel<KEY_TYPE>, FORM extends BaseForm<KEY_TYPE>, KEY_TYPE extends Serializable> {
	...
	public ModelAndView doAdd(@Valid FORM form, BindingResult result, RedirectAttributes redirectAttributes) {
		...
		ModelAndView modelAndView = new ModelAndView("redirect:" + (StringTool.isEmpty(form.getActionPath())?getActionPath():form.getActionPath()) + "/list.htm");
