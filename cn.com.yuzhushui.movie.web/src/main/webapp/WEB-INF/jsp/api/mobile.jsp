...
<body class="mWrap" style="background:#f7f3f3">
	<header class="topHd">
		...
		<div class="content"><input name="content" style="width: 100%;height: 100%;" placeholder="输入要查询的手机号" maxlength="30" size="30" id="content"/></div>
...
<script type="text/javascript">
		var start=false;
		$(function(){
			$("#results").append("<div style='margin: 7px 9px;font-size: 15px;font-family: initial;font-weight: bold;'>您好，请输入要查询的手机号。</div>");
