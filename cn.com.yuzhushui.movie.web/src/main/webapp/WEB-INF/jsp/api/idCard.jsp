...
<body class="mWrap" style="background:#f7f3f3">
	<header class="topHd">
	  ...
	  <div style="position: absolute;top: 3.9em;bottom: 40px;width: 100%;">
		...
		<div class="content" style="height: 8%;"><input name="content" style="width: 100%;height: 100%;" placeholder="输入要查询的身份证号" maxlength="30" size="30" id="content"/></div>
	  </div>
...
<script type="text/javascript">
		var start=false;
		$(function(){
			$("#results").append("<div style='margin: 7px 9px;font-size: 17px;'>请输入要查询的身份证号。</div>");
			$("#content").select();
