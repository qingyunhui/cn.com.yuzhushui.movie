...
@Getter
@Setter
public class SysWarningForm extends BaseForm<Integer> {
	...
	/**
	 * @Fields method_name:方法名称
	 */
	private String methodName;
	
	/**
	 * @Fields return_type:返回类型
	 */
	private String returnType;
	
	/**
	 * @Fields return_value:返回值
	 */
	...
	/**
	 * @Fields contact_way:联系方式(电话,邮箱都可以)
	 */
